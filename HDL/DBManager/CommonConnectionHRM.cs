...
namespace DBManager
{
    public class CommonConnectionHRM
    {
        public string constring = ConfigurationManager.ConnectionStrings["SqlConnectionStringHRM"].ToString();
        ...
        public CommonConnectionHRM(IsolationLevel readCommitted)
        {
            ...
            if (ConnectionType != null && ConnectionType == "SQL")
            {
                ...
                dbConnection = new SqlConnection(connections["SqlConnectionStringHRM"].ConnectionString);
                IsConfigureDb = true;
            }
            else
            {
