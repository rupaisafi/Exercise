...
namespace DBManager.StoreProcedureHRM
{
    public class KendoGrid<T>
    {
       ...
       private static string ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["SqlConnectionStringHRM"].ConnectionString;
